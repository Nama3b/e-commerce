                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_id">
                                                @foreach ($category as $option)
                                                    <option
                                                        value="{{ $option['id'] }}" {{ $option['id'] = $item['category_id'] ? 'selected' : '' }}>{{ $option['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="brand_id">
                                                @foreach ($brand as $option)
                                                    <option
                                                        value="{{ $option['id'] }}" {{ $option['id'] = $item['brand_id'] ? 'selected' : '' }}>{{ $option['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <img src="../{{ $item['url'] }}" alt="" style="float: right; width: 72%;">
                            <input type="hidden" name="thumbnail_image" value="{{ $item['url'] }}">
