                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4 mt-4">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $member->full_name }}'s Profile</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-input" name="full_name" value="{{ $member->full_name }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="password" class="form-input" name="password" value="{{ $member->password }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-input" name="phone_number" value="{{ $member->phone_number }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-input" name="address" value="{{ $member->address }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9">
                                        <input type="date" class="form-input" name="birthday" value="{{ $member->birthday }}">
                                    </div>
                                </div>
                            </div>
                        </div>
